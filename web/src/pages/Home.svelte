<script lang="ts">
    ...
    const btnClass = "bg-[#E1FF00] px-[100px] py-[20px] cursor-pointer hover:rounded-full text-black font-poppins text-[64px] flex items-center justify-center tracking-wide select-none active:scale-[0.98] ease-in-out";
</script>
...
<div bind:this={containerEl} class="relative bg-[#090909] min-h-screen w-full overflow-hidden select-none">
    ...
    {:else}
        ...
        <div class="flex flex-col bottom-[100px] left-[100px] absolute gap-[12px]" data-obstacle>
            ...
            <button type="button" class={btnClass} onclick={() => { window.location.href="/#/lobby/join" }}>
